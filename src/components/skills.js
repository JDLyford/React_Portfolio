    ...
    return(
        <section id='skills'>
            ...
            <div className="container">
                ...
                <div className="col s6 push-l6 skillsText"><strong>React's</strong> declaractive component structure combined with <strong>Redux</strong></div>  
                ...
                <div className="col s12 l6 skills">
                    ...
                    <div className="col s6 skillsText">Experience with <strong>CRUD</strong> operations using both the industry standard <strong>PHP</strong> with <strong>MySQL</strong> and <strong>Node.js</strong> with <strong>MongoDB</strong></div>
                </div>
                
                <div className="col s12 l6 skills"></div>
